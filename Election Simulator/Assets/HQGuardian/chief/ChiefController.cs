...
public class ChiefController : MonoBehaviour {
	...
	private Transform chiefTransform;
	...
	void Start () {
		...
		chiefTransform = GetComponent<Transform> ();
	}
	...
	public void NextTarget () {
		if (nextTargets.Count > 0) {
			...
			//			Quarterion
			//			chiefTransform.rotation.eulerAngles = Vector3.Angle (curPosition, new Vector3(currentTarget.x, currentTarget.y, 0));
			currentSpeed = GetSpeedVector (currentTarget);
